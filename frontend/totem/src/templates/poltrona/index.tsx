  ...
  return (
    <div className="poltrona-page">
      ...
      <div className="footer">
        <button className="back-button" onClick={() => setTabActive(tabActive - 1)}>Voltar</button>
        <span>{selectedSeats.length} assentos selecionados</span>
        <button className="next-button" onClick ={() => setTabActive(tabActive + 1)}>Próximo</button>
      </div>
    </div>
  );
};
